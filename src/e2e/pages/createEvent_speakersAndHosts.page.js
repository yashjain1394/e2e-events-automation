...
class SpeakersAndHosts extends EventsBasePage {
    constructor() {
        ...
        this.locators = {
            ...
            bio: (profileContainerIndex) => `profile-container.profile-component div.profile-container:nth-of-type(${profileContainerIndex+1}) profile-ui.form-component custom-textfield sp-textfield[placeholder="Add bio"] textarea[placeholder="Add bio"]`,
